...
@section('content')
    <div class="flex-1 p-6 overflow-hidden">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Galeri</h2>
                    ...
                    <tbody>
                        @foreach ($galeri as $key => $galeri)
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">{{ $galeri->kategori->nama }}</td>
                                <td class="py-2 px-4 border-b">{{ $galeri->judul }}</td>
                                {{-- <td class="py-2 px-4 border-b">{{ $galeri->slug }}</td>
                                <td class="py-2 px-4 border-b">{{ $galeri->isi }}</td> --}}
                                <td class="py-2 px-4 border-b">
                                    <div class="flex item-center space-x-2">
                                        <!-- Tombol Edit dengan Modal Trigger -->
                                        <a href="{{ route('admin.galeri.edit', $galeri->id) }}" class="text-blue-500"><svg
                                        ...
                                        <button onclick="openDeleteModal({{ $galeri->id }})"
    ...
    <script>
        ...
        function openDeleteModal(id) {
            document.getElementById('deleteForm').action = `/galeri/${id}/delete`;

...
@section('content')
    <div class="flex-1 p-6 overflow-auto">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Berita</h2>
                ...
                <table class="min-w-full bg-white border border-gray-200" id="example1">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b">Nama Berita</th>
                    ...
                    <tbody>
                        @foreach ($beritas as $key => $berita)
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">{{ $berita->isi }}</td>
                                <td class="py-2 px-4 border-b">
                                    <div class="flex item-center space-x-2">
                                        <!-- Tombol Edit dengan Modal Trigger -->
                                        <a href="{{ route('admin.berita.edit', $berita->id) }}" class="text-blue-500"><svg
    ...
    <script>
        ...
        function openDeleteModal(id) {
            document.getElementById('deleteForm').action = `/berita/${id}/delete`;
